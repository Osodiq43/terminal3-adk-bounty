...
const DEBUG = env.PREVIEW2_SHIM_DEBUG === "0"
    ? false
 ...
 */
export let ioCall = createSyncFn((options) => new Worker(new URL("./worker-thread.bundle.js", import.meta.url), options), DEBUG, (type, id, payload) => {
    ...
    static _create(streamType, id) {
        ...
        switch (streamType) {
            ...
            case HTTP:
                ...
                break;
            default:
                throw new Error("wasi-io trap: Dispose function not created for stream type " +
