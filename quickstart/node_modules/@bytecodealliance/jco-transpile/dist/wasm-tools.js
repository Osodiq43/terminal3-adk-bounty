 ...
 */
export async function componentWitMetadataForWorld(worldWitSpecifier, worldName) {
    await $init;
 ...
 */
export async function metadataShow(bytes) {
    await $init;
 ...
 * @returns WebAssembly component bytes
 */
export async function componentNew(bytes, adapters) {
    await $init;
 ...
 */
export async function componentWit(bytes) {
    await $init;
 ...
 */
export async function componentEmbed(opts) {
    await $init;
 ...
 * @returns WebAssembly binary bytes with WIT metadata embedded
 */
export async function metadataAdd(bytes, metadata) {
    await $init;
