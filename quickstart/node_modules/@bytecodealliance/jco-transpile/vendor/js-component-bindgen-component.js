...
function generate(arg0, arg1) {
  ...
  var {name: v2_0, noTypescript: v2_1, instantiation: v2_2, importBindings: v2_3, map: v2_4, compat: v2_5, noNodejsCompat: v2_6, base64Cutoff: v2_7, tlaCompat: v2_8, validLiftingOptimization: v2_9, tracing: v2_10, noNamespacedExports: v2_11, guest: v2_12, multiMemory: v2_13, bindgenEnableWasmExnref: v2_14, asyncMode: v2_15, strict: v2_16, asmjs: v2_17 } = arg1;
  ...
  if (variant23 === null || variant23=== undefined) {
    ...
    dataView(memory0).setInt8(ptr0 + 61, e ? 1 : 0, true);
  }
  var variant30 = v2_15;
  if (variant30 === null || variant30=== undefined) {
    ...
    switch (variant29.tag) {
      ...
      case 'jspi': {
        ...
        var {imports: v24_0, exports: v24_1 } = e;
        var vec26 = v24_0;
        ...
        dataView(memory0).setUint32(ptr0 + 76, len26, true);
        dataView(memory0).setUint32(ptr0 + 72, result26, true);
        var vec28 = v24_1;
        var len28 = vec28.length;
        var result28 = realloc1(0, 0, 4, len28 * 8);
        for (let i = 0; i < vec28.length; i++) {
          const e = vec28[i];
          const base = result28 + i * 8;
          var encodeRes = _utf8AllocateAndEncode(e, realloc1, memory0);
          var ptr27= encodeRes.ptr;
          var len27 = encodeRes.len;
          
          dataView(memory0).setUint32(base + 4, len27, true);
          dataView(memory0).setUint32(base + 0, ptr27, true);
        }
        dataView(memory0).setUint32(ptr0 + 84, len28, true);
        dataView(memory0).setUint32(ptr0 + 80, result28, true);
        break;
      }
      default: {
        throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant29.tag)}\` (received \`${variant29}\`) specified for \`AsyncMode\``);
      }
    }
  }
  var variant31 = v2_16;
  if (variant31 === null || variant31=== undefined) {
    ...
    dataView(memory0).setInt8(ptr0 + 89, e ? 1 : 0, true);
  }
  var variant32 = v2_17;
  if (variant32 === null || variant32=== undefined) {
    dataView(memory0).setInt8(ptr0 + 90, 0, true);
  } else {
    const e = variant32;
    dataView(memory0).setInt8(ptr0 + 90, 1, true);
    dataView(memory0).setInt8(ptr0 + 91, e ? 1 : 0, true);
  }
  ...
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      var len35 = dataView(memory0).getUint32(ret + 8, true);
      var base35 = dataView(memory0).getUint32(ret + 4, true);
      var result35 = [];
      for (let i = 0; i < len35; i++) {
        ...
        var ptr34 = dataView(memory0).getUint32(base + 8, true);
        var len34 = dataView(memory0).getUint32(base + 12, true);
        var result34 = new Uint8Array(memory0.buffer.slice(ptr34, ptr34 + len34 * 1));
        result35.push([result33, result34]);
      }
      var len37 = dataView(memory0).getUint32(ret + 16, true);
      var base37 = dataView(memory0).getUint32(ret + 12, true);
      var result37 = [];
      for (let i = 0; i < len37; i++) {
        const base = base37 + i * 8;
        ...
        result37.push(result36);
      }
      var len40 = dataView(memory0).getUint32(ret + 24, true);
      var base40 = dataView(memory0).getUint32(ret + 20, true);
      var result40 = [];
      for (let i = 0; i < len40; i++) {
        const base = base40 + i * 12;
        var ptr38 = dataView(memory0).getUint32(base + 0, true);
        var len38 = dataView(memory0).getUint32(base + 4, true);
    ...
    case 1: {
      var ptr41 = dataView(memory0).getUint32(ret + 4, true);
      var len41 = dataView(memory0).getUint32(ret + 8, true);
      var result41 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr41, len41));
      variant42= {
        tag: 'err',
        val: result41
      };
...
export const $init = (() => {
  let gen = (function* _initGenerator () {
    ...
    const module2 = base64Compile('');
    const module3 = base64Compile('');
