...
function stubWasi(arg0, arg1, arg2, arg3, arg4) {
  ...
  _debugLog('[iface="local:spidermonkey-embedding-splicer/splicer", function="stub-wasi"] [Instruction::CallWasm] (async? false, @ enter)');
  const _wasm_call_currentTaskID = startCurrentTask(0, false, 'splicerStubWasi');
  const ret = splicerStubWasi(ptr0, len0, result2, len2, variant4_0, variant4_1, variant4_2, variant6_0, variant6_1, variant6_2, variant8_0, variant8_1, variant8_2);
  endCurrentTask(0);
  let variant11;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    ...
    case 1: {
      var ptr10 = dataView(memory0).getUint32(ret + 4, true);
  ...
  _debugLog('[iface="local:spidermonkey-embedding-splicer/splicer", function="stub-wasi"][Instruction::Return]', {
    funcName: 'stub-wasi',
    paramCount: 1,
    postReturn: true
  });
...
function spliceBindings(arg0, arg1, arg2, arg3, arg4, arg5) {
  ...
  _debugLog('[iface="local:spidermonkey-embedding-splicer/splicer", function="splice-bindings"] [Instruction::CallWasm] (async? false, @ enter)');
  const _wasm_call_currentTaskID = startCurrentTask(0, false, 'splicerSpliceBindings');
  const ret = splicerSpliceBindings(ptr0, len0, result2, len2, variant4_0, variant4_1, variant4_2, variant6_0, variant6_1, variant6_2, variant8_0, variant8_1, variant8_2, arg5 ? 1 : 0);
  endCurrentTask(0);
  let variant23;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      ...
      var result10 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr10, len10));
      var len18 = dataView(memory0).getUint32(ret + 24, true);
      var base18 = dataView(memory0).getUint32(ret + 20, true);
      var result18 = [];
      for (let i = 0; i < len18; i++) {
        ...
        var base13 = dataView(memory0).getUint32(base + 8, true);
        var result13 = [];
      ...
      var len21 = dataView(memory0).getUint32(ret + 32, true);
      var base21 = dataView(memory0).getUint32(ret + 28, true);
      var result21 = [];
  ...
  _debugLog('[iface="local:spidermonkey-embedding-splicer/splicer", function="splice-bindings"][Instruction::Return]', {
    funcName: 'splice-bindings',
    paramCount: 1,
    postReturn: true
  });
...
const $init = (() => {
  let gen = (function* init () {
    ...
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    ({ exports: exports2 } = yield instantiateCore(yield module1, {
      ...
      'wasi:filesystem/types@0.2.3': {
        '[method]descriptor.append-via-stream': exports0['24'],
        '[method]descriptor.get-flags': exports0['17'],
        ...
        '[method]descriptor.read-directory': exports0['25'],
        '[method]descriptor.read-via-stream': exports0['22'],
        '[method]descriptor.stat': exports0['26'],
        '[method]descriptor.stat-at': exports0['27'],
        ...
        'filesystem-error-code': exports0['20'],
      },
      'wasi:io/error@0.2.3': {
        '[resource-drop]error': trampoline3,
      },
      'wasi:io/streams@0.2.3': {
        '[method]input-stream.blocking-read': exports0['31'],
        '[method]input-stream.read': exports0['30'],
        '[method]output-stream.blocking-flush': exports0['35'],
        '[method]output-stream.blocking-write-and-flush': exports0['34'],
        '[method]output-stream.check-write': exports0['32'],
        '[method]output-stream.write': exports0['33'],
    ...
    ({ exports: exports3 } = yield instantiateCore(yield module3, {
      '': {
        ...
        '10': exports2.fd_readdir,
        '11': exports2.fd_write,
        '12': exports2.path_filestat_get,
    ...
    splicerStubWasi = exports1['local:spidermonkey-embedding-splicer/splicer#stub-wasi'];
    splicerSpliceBindings = exports1['local:spidermonkey-embedding-splicer/splicer#splice-bindings'];
  })();
