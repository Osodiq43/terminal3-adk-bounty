...
import { isWildcardIpAddress, isUnicastIpAddress, isMulticastIpAddress, isIpv4MappedAddress, isBindableIpAddress, IP_ADDRESS_FAMILY, } from "./address.js";
let WORKER = null;
const symbolDispose = Symbol.dispose || Symbol.for("dispose");
function worker() {
    return (WORKER ??= new ResourceWorker(() => new Worker(new URL("../workers/tcp-worker.bundle.js", import.meta.url))));
}
...
export class TcpSocket {
    ...
    #isValidLocalAddress(localAddress) {
        return (this.#family === localAddress.tag &&
    ...
    #isValidRemoteAddress(remoteAddress) {
        return (this.#family === remoteAddress.tag &&
