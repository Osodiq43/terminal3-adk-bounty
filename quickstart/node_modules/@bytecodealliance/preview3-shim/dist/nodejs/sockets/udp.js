...
import { isWildcardIpAddress, isUnicastIpAddress, isIpv4MappedAddress, isBindableIpAddress, IP_ADDRESS_FAMILY, } from "./address.js";
let WORKER = null;
function worker() {
    return (WORKER ??= new ResourceWorker(() => new Worker(new URL("../workers/udp-worker.bundle.js", import.meta.url))));
}
