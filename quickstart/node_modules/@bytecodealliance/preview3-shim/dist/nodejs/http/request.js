...
import { DEFAULT_BYTE_STREAM_CHUNK_SIZE, StreamReader, _byteChunk, readableByteStreamFromReader, } from "../stream.js";
...
function readableContentsStream(reader, headers) {
    ...
    const source = typeof reader?.read === "function"
        ? reader
...
function readOpts(remaining) {
    ...
    const count = Number(remaining <= BigInt(DEFAULT_BYTE_STREAM_CHUNK_SIZE)
        ? remaining
