...
export function _byteChunk(value) {
    ...
    throw new TypeError("byte stream chunk must be a byte, byte array, ArrayBuffer, Uint8Array, or string");
}
...
export function stream(opts = {}) {
    ...
    const transform = new TransformStream({}, { highWaterMark: writableHWM }, { highWaterMark: readableHWM });
...
export class StreamReader {
    ...
    constructor(source, opts = {}) {
        if (!source ||
            ...
            throw new Error("Failed to create StreamReader: provided source must implement [Symbol.asyncIterator]() or [Symbol.iterator]()");
        }
        this.#source = source;
        ...
        if (source instanceof ReadableStream) {
            ...
            this.#iterator = {
                ...
                return(val) {
                    return Promise.resolve(syncIterator.return ? syncIterator.return(val) : { done: true, value: val });
                },
            };
        }
    }
