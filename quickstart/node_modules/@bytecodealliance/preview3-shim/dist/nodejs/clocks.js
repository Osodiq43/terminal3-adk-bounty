import { wallClock, monotonicClock as monotonicClockV2, } from "@bytecodealliance/preview2-shim/clocks";
...
export const systemClock = {
    ...
    getResolution() {
        ...
        return BigInt(dt.seconds) * 1000000000n + BigInt(dt.nanoseconds);
    },
};
// eslint-disable-next-line no-unused-vars
const { subscribeInstant, subscribeDuration, ...baseMonotonicClock } = monotonicClockV2;
const sleep = (ms) => new Promise((resolve) => setTimeout(resolve, ms));
const nsToTimeoutMs = (ns) => (ns + 999999n) / 1000000n;
